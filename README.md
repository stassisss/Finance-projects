**Google Colab link to the main file**: *https://colab.research.google.com/github/stassisss/Finance-projects/blob/main/ML_implied_volatility_predict.ipynb*
...
The parameter $\sigma$ here is the *implied volatility (IV)*.  
...
This project aims to build a direct **ML surrogate** that maps **observable market features** (like moneyness, time-to-maturity, bid-ask spread, put-call parity gap) to the **implied volatility**, replacing iterative Black-Scholes inversion with direct prediction.
